  const cambio = async () => { try { return (await import("~/json/monetaria/blue/usd.json")).default } catch (t) { return console.log(t), [] } };
  const adr = async () => { try { return (await import("~/json/monetaria/blue/blue.json")).default } catch (t) { return console.log(t), [] } };
