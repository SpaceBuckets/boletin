...
<h4 class="chartitle"><strong>IPI</strong>: Índice de Producción Industrial Manufacturero <br>Frecuencia Mensual<br>Base 2004 </h4>
           <charts-line
            :key="$state.updated"
            :data="chartData"
    ...
    return {
      ...
      chartOptions: {
        ...
        scales: {
          ...
          yAxes: [{
            ticks: { suggestedMin: 70,suggestedMax: 160,fontColor: "#888", },
            gridLines: { 
              color: "#eee", 
              lineWidth: 1, 
              drawBorder: false,          
