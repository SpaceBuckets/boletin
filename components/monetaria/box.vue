  ...
  data() {
    return {
      ...
      econdates: {
        ...
        comprasmensual: comprasDates[comprasDates.length - 1].replace(/-/g, "/").split('/').reverse().join('/'),
        comprasdiarias: comprasDates[comprasDates.length - 1].replace(/-/g, "/").split('/').reverse().join('/')
