...
const generatedTime = require(`../../generatedTime.json`)
  const kpi = "uva"
  try { 
  await parsers.datosGobarAPI(kpi, "uva", '94.2_UVAD_D_0_0_10')
  ...
  chartdata: {
    labels: require(`../../data/${generatedTime}/${kpi}/uva/dates.json`),
    datasets: [
      {
        backgroundColor: "rgba(46,120,210,0.05)",
        label: "UVA",
        data: require(`../../data/${generatedTime}/${kpi}/uva/d.json`),
