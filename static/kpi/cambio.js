module.exports = {
  ...
  chartdata: {
  labels: require("../data/ambito/oficial/dates.json"),
  datasets: [
    {
      backgroundColor: "rgba(0,153,102,0.0)",
      label: "Oficial",
      data: require("../data/ambito/oficial/d.json"),
      borderColor: "#009966",
      pointRadius: 0,
      borderWidth: 1.5,
    ...
    },
    {
      ...
      label: "Blue",
      data: require("../data/ambito/blue/d.json"),
      borderColor: "#2E78D2",
      pointRadius: 0,
      borderWidth: 1.25,
    ...
    },
    {
      backgroundColor: "rgba(178,34,34,0)",
      label: "CCL",
      data: require("../data/ambito/ccl/d.json"),
    ...
    },
    {
      backgroundColor: "rgba(178,34,34,0)",
      label: "MEP",
      data: require("../data/ambito/mep/d.json"),
