module.exports = (async function() {
  ...
  for (let [key, value] of Object.entries(reambito)) {
      ...
      parsers.writeFileSyncRecursive(`./static/data/${generatedTime}/cambio/${key}/dates.json`, JSON.stringify(datesArray.reverse()));
      parsers.writeFileSyncRecursive(`./static/data/${generatedTime}/cambio/${key}/d.json`, JSON.stringify(tempArray.reverse()));
  ...
  var post = {
    ...
    datasets: [
        ...
        },
        {
          backgroundColor: "rgba(178,34,34,0)",
          label: "Turista",
          data: require(`../../data/${generatedTime}/${kpi}/turista/d.json`),
        ...
        },
        {
          backgroundColor: "rgba(178,34,34,0)",
          label: "Qatar",
          data: require(`../../data/${generatedTime}/${kpi}/qatar/d.json`),
          borderColor: "#00996640",
          pointRadius: 0,
          borderWidth: 1.25,
        },    
        ...
        },    
        {
          backgroundColor: "rgba(178,34,34,0)",
          label: "Lujo",
          data: require(`../../data/${generatedTime}/${kpi}/lujo/d.json`),
          borderColor: "#00996640",
          pointRadius: 0,
          borderWidth: 1.25,
        },    
