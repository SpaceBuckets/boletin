module.exports = (async function() {
  ...
  parsers.writeFileSyncRecursive(`./static/data/brecha/blue/dates.json`, JSON.stringify(dateUSD.reverse()));
  parsers.writeFileSyncRecursive(`./static/data/brecha/blue/gap.json`, JSON.stringify(valGap.reverse()));
  ...
  var post = {
    ...
    chartdata: {
      labels: require(`../../data/${kpi}/blue/dates.json`),
      datasets: [
        {
          backgroundColor: "rgba(178,34,34,0.05)",
          label: "Brecha USD / Peso",
          data: require(`../../data/${kpi}/blue/gap.json`),
