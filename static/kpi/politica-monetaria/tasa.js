...
try {
  ...
  chartdata: {
    labels: require(`../../data/${kpi}/tasadates.json`),
    datasets: [
      {
        backgroundColor: "rgba(46,120,210,0)",
        label: "Referencia",
        data: require(`../../data/${kpi}/tasatasa.json`),
        borderColor: "#2E78D2",
        pointRadius: 0,
        borderWidth: 1.5,
      },
      {
        backgroundColor: "rgba(46,120,210,0)",
        label: "Badlar",
        data: require(`../../data/${kpi}/tasabadlar.json`),
      ...
      },
      {
        backgroundColor: "rgba(46,120,210,0)",
        label: "Plazo Fijo",
        data: require(`../../data/${kpi}/tasaplazo.json`),
        borderColor: "rgba(46,120,210,0.25)",
        pointRadius: 0,
        borderWidth: 1,
      },
      {
        ...
        data: require(`../../data/${kpi}/tasapases.json`),
