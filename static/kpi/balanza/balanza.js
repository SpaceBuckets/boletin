...
const generatedTime = require(`../../generatedTime.json`)
  ...
  var post = {
    ...
    c: "<p>Las estadísticas del comercio exterior se elaboran principalmente sobre la base de los registros aduaneros (permisos de embarque para las exportaciones y despachos de importación para las importaciones). Para completar la cobertura, se utilizan encuestas a entes binacionales de producción de energía eléctrica, gas y a empresas de transporte marítimo y aéreo como única fuente de información complementaria. Para el caso de las exportaciones, al momento de difundir los datos solo se dispone de una parte de la documentación.</p>",
