...
module.exports = (async function() {
  ...
  const kpi = "capturapesquera"
  const url = 'https://infra.datos.gob.ar/catalog/sspm/dataset/39/distribution/39.2/download/captura-pesquera-por-categorias-valores-trimestrales.csv'
