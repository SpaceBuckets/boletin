module.exports = {
  ...
  "min": 0,
  chartdata: {
  labels: require("../data/bonosusd/al30d/dates.json"),
  datasets: [
    {
      backgroundColor: "rgba(46,120,210,0.0)",
      label: "AL30D",
      data: require("../data/bonosusd/al30d/d.json"),
    ...
    },
    {
      backgroundColor: "rgba(46,120,210,0.0)",
      label: "AL29D",
      data: require("../data/bonosusd/al29d/d.json"),
    ...
    },
    {
      backgroundColor: "rgba(46,120,210,0.0)",
      label: "AL41D",
      data: require("../data/bonosusd/al41d/d.json"),
      borderColor: "rgba(46,120,210,0.25)",
      pointRadius: 0,
      borderWidth: 1.5,
    },   
    {
      backgroundColor: "rgba(46,120,210,0.0)",
      label: "GD30D",
      data: require("../data/bonosusd/gd30d/d.json"),
      borderColor: "rgba(46,120,210,0.25)",
      pointRadius: 0,
      borderWidth: 1.5,
    },   
    {
      backgroundColor: "rgba(46,120,210,0.0)",
      label: "GD35D",
      data: require("../data/bonosusd/gd35d/d.json"),
      borderColor: "rgba(46,120,210,0.25)",
      pointRadius: 0,
      borderWidth: 1.5,
    },   
    {
      backgroundColor: "rgba(46,120,210,0.0)",
      label: "GD41D",
      data: require("../data/bonosusd/gd41d/d.json"),
      borderColor: "rgba(46,120,210,0.25)",
      pointRadius: 0,
      borderWidth: 1.5,
    },               
