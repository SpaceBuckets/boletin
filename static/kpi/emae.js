module.exports = {
  ...
  chartdata: {
    labels: require("../data/emae/base/dates.json"),
    datasets: [
      {
        fill: false,
        label: "Desestacionalizado",
        data: require("../data/emae/estacional/d.json"),
        borderColor: "#2E78D2",
        pointRadius: 0,
        borderWidth: 1.5,
      },
      {
        fill: false,
        label: "Tendencia",
        data: require("../data/emae/tendencia/d.json"),
      ...
      },
      {
        fill: false,
        label: "Base",
        data: require("../data/emae/base/d.json"),
