module.exports = (async function() {
  ...
  const payload = await parsers.datosGobarCSV(0,19,url)
  const post = {
    kpi,
    t: "Ventas Gasoil",
    st: "Por Empresa",
    ...
    dimensions: [
      ...
      {
        label: "AXXION",
        data: await parsers.datosGobarCSV(0,20,url),
        color: "rgba(46,120,210,0.5)",
      },
      {
        label: "Shell",
        data: await parsers.datosGobarCSV(0,21,url),
        color: "rgba(46,120,210,0.2)",
      },
      {
        label: "Petrobras",
        data: await parsers.datosGobarCSV(0,22,url),
        color: "rgba(46,120,210,0.2)",
      },       
      {
        label: "Oil",
        data: await parsers.datosGobarCSV(0,23,url),
        color: "rgba(46,120,210,0.2)",
      },       
