module.exports = (async function() {
  ...
  const payload = await parsers.datosGobarCSV(0,24,url)
  const post = {
    kpi,
    t: "Ventas Naftas",
    st: "Por Empresa",
    ...
    dimensions: [
      ...
      {
        label: "AXXION",
        data: await parsers.datosGobarCSV(0,25,url),
        color: "rgba(46,120,210,0.5)",
      },
      {
        label: "Shell",
        data: await parsers.datosGobarCSV(0,26,url),
        color: "rgba(46,120,210,0.2)",
      },
      {
        label: "Petrobras",
        data: await parsers.datosGobarCSV(0,27,url),
        color: "rgba(46,120,210,0.2)",
      },       
      {
        label: "Oil",
        data: await parsers.datosGobarCSV(0,28,url),
        color: "rgba(46,120,210,0.2)",
      },                                    
]
}
